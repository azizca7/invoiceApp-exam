...
const getFieldLabel = (field) => {
  const fieldMap = {
    ...
    items: "Items",
    senderAddress_street: "Sender Address (Street)",
    senderAddress_city: "Sender Address (City)",
    senderAddress_postCode: "Sender Address (Post Code)",
    senderAddress_country: "Sender Address (Country)",
    clientAddress_street: "Client Address (Street)",
    clientAddress_city: "Client Address (City)",
    clientAddress_postCode: "Client Address (Post Code)",
    clientAddress_country: "Client Address (Country)",
  };
  ...
  if (
    ...
    const fieldType = field.split(index)[1];
...
export default function InvoiceForm({ invoice = null, isOpen, onClose }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.clientName.trim() || formData.clientName.trim().length < 4) {
    ...
    if (
      ...
      formData.clientEmail.trim().length < 4
    ) {
    ...
    ["senderAddress", "clientAddress"].forEach((addressType) => {
    ...
    Object.entries(errors).forEach(([field, message]) => {
      setTimeout(() => {
        toast.warning(message, {
          description: `Field: ${getFieldLabel(field)}`,
        });
      }, 100);
    });
  };
  ...
  return (
    <>
      ...
      <Sheet open={isOpen} onOpenChange={onClose}>
        <SheetContent
          side="left"
          className={`w-full md:max-w-[720px] p-6 pt-20 md:pt-6 md:pl-28 ${
              ...
              <div className="space-y-4 ">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-4 items-center">
                  <div className="flex flex-col gap-4">
                    <Label htmlFor="createdAt" className="whitespace-nowrap">
                      Pick a Date
                    </Label>
                    <Popover>
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger
                        className={isDarkMode ? "bg-[#1E2139] border-none" : ""}
                      >
